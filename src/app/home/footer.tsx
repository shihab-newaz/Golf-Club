        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-white font-semibold">GOLF CLUB</span>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-gray-300">Membership</a></li>
              <li><a href="#" className="hover:text-gray-300">Facilities</a></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-gray-300">Golf Lessons</a></li>
              <li><a href="#" className="hover:text-gray-300">Pro Shop</a></li>
          ...
          <div className="col-span-1">
            ...
            <div className="flex flex-col space-y-2">
              ...
              />
              <Button className="bg-white text-black rounded-md hover:bg-gray-200 w-3/4">
                Subscribe
              </Button>
            </div>
          </div>
